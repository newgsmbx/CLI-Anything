...
wavetone       28 passed  ✅   (23 unit + 5 default e2e, 2 backend-gated e2e skipped; 30 passed opt-in)
...
├── wavetone/agent-harness/              # WaveTone CLI (30 tests: 28 default + 2 backend-gated e2e)
