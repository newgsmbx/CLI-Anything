...
@click.option("--campaign-id", default=None, help="Restrict results to orders with a specific `campaign_id` value.")
@click.option("--outreach-id", default=None, help="Restrict results to orders with a specific `outreach_id` value.")
@click.option("--customer-id", default=None, help="Restrict results to orders made by a specific customer.")
@click.option("--has-outreach", default=None, type=bool, help="Restrict results to orders that have an outreach attached. For example, an email")
...
@click.option("--count", default=None, type=int, help="The number of records to return. Default value is 10. Maximum value is 1000")
@click.option("--offset", default=None, type=int, help="Used for [pagination](https://mailchimp.com/developer/marketing/docs/methods-par")
@click.option("--email-address", default=None, help="Restrict the response to customers with the email address.")
@click.option("--extra-params", default=None, help="Extra query params as JSON object, e.g. '{\"key\":\"val\"}'")
@click.pass_context
