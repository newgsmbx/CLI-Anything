...
@click.option("--type", default=None, help="The file type for the File Manager file.")
@click.option("--created-by", default=None, help="The Mailchimp account user who created the File Manager file.")
@click.option("--before-created-at", default=None, help="Restrict the response to files created before the set date. Uses ISO 8601 time f")
@click.option("--since-created-at", default=None, help="Restrict the response to files created after the set date. Uses ISO 8601 time fo")
